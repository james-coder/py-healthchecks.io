...
def fake_check_api_result() -> Dict[str, Union[str, int]]:
    yield {
        ...
        "update_url": "testhc.io/api/v3/checks/8f57a84b-86c2-4246-8923-02f83d17604a",
        "pause_url": "testhc.io/api/v3/checks/8f57a84b-86c2-4246-8923-02f83d17604a/pause",
        "channels": "*",
        "timeout": 259200,
    }
...
def fake_check() -> checks.Check:
    yield checks.Check(
        ...
        update_url="testurl.com/api/v3/checks/test-uuid",
        pause_url="testurl.com/api/v3/checks/test-uuid/pause",
        channel="*",
        timeout=86400,
        uuid="test-uuid",
    )
